...
- GF 0p3 analog pad exerciser in [ANALOG](./src/ANALOG/): sigma-delta DAC output, monitor mux, divider/TRNG monitor, charge/release/sample probe sequence on ua[0]..ua[5], and analog status readback at R14/0xE.
