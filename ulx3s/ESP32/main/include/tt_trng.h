...
#define TT_TRNG_REG_CTRL       0x00U
#define TT_TRNG_REG_SRC        0x01U
#define TT_TRNG_REG_DIV        0x02U
#define TT_TRNG_REG_MODE       0x03U
#define TT_TRNG_REG_OSCEN      0x04U
#define TT_TRNG_REG_STATUS     0x05U
#define TT_TRNG_REG_RAWLO      0x06U
#define TT_TRNG_REG_RAWHI      0x07U

#ifdef TT_MACRO_BIG16_SPI_REG
    #define TT_TRNG_REG_UI_IN     0x08U
    #define TT_TRNG_REG_UO_OUT    0x09U
    #define TT_TRNG_REG_UIO_IN    0x0AU
    #define TT_TRNG_REG_UIO_OUT   0x0BU
    #define TT_TRNG_REG_UIO_OE    0x0CU
#endif

#define TT_TRNG_CTRL_NONE         0x00U
#define TT_TRNG_CTRL_ENABLE       0x01U
#define TT_TRNG_CTRL_SINGLE_STEP  0x02U
#define TT_TRNG_CTRL_RESET        0x04U

#define TT_TRNG_BITS_PER_SAMPLE        16U
#define TT_TRNG_LIVE_SAMPLE_DELAY_MS   10U

#define TT_TRNG_DEFAULT_DIV       0x10U
